...
import indiana.cgl.hadoop.pagerank.helper.SortResultsMap;
import indiana.cgl.hadoop.pagerank.helper.SortResultsReduce;
...
public class HadoopPageRank extends Configured implements Tool{
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Hadoop SortResults starts...\n");
		/////////////////////////////////////////////////////
		//collect the (url_id,rank_value) tuple from output in stage 3
		
		Job job4 = new Job(config, "SortResults");
		
		job4.setJarByClass(HadoopPageRank.class);
		job4.setMapperClass(SortResultsMap.class);
		job4.setReducerClass(SortResultsReduce.class);
		...
		if (!job4.isSuccessful()){
			System.out.println("Hadoop SortResults failed, exit...");
			System.exit(-1);
		}
